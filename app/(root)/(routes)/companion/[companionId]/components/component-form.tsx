...
import { ImageUpload } from "@/components/aicompanion/image-upload";
...
export const CompanionForm = ({
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      toast.success("Successfull created companion")
  ...
  // using chadcn and react hook form
  return (
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Textarea disabled={isLoading} rows={11} className="bg-background resize-none" placeholder={SEED_CHAT} {...field} />
                </FormControl>
                <FormDescription>
